 ...
 */
#define OPENER_CIP_NUM_EXPLICIT_CONNS 8
 ...
 *
 */
#define OPENER_CIP_NUM_EXLUSIVE_OWNER_CONNS 3
 ...
 *
 */
#define OPENER_CIP_NUM_INPUT_ONLY_CONNS 3
 ...
 *
 */
#define OPENER_CIP_NUM_LISTEN_ONLY_CONNS 3
